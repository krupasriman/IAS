  ...
  if (!topic) {
    return (
      <div className="max-w-2xl mx-auto text-center py-24">
        ...
        <h2 className="text-2xl font-bold text-slate-900 mb-2">Topic not found</h2>
        <p className="text-slate-500 mb-8">The topic you're looking for doesn't exist or may have been deleted.</p>
        <Link
          to="/"
