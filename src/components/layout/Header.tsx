...
import { Settings, GraduationCap, PlusCircle, Home, BookOpen } from 'lucide-react';
          ...
          <div className="flex items-center gap-3">
            <Link to="/" className="flex items-center gap-2.5">
              ...
              <div className="leading-tight">
                <div className="font-bold text-lg text-slate-900 tracking-tight">IAS Study</div>
                <div className="text-[10px] uppercase tracking-widest text-slate-500 font-medium">Mains Framework</div>
              </div>
            </Link>
          </div>
